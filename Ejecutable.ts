...
import { Tragamonedas1} from './Tragamonedas1';
...
let edad: number = readlineSync.questionInt(); //  Captura la edad del jugador
//inicio ganancia
let gananciatotal=0
//---------------------------------------------------------------------------------------------------------------
//Creamos objetos
let jugador1: Persona; //mantuve esta linea y agregue el bloque try/catch abajo
try {
    jugador1 = new Persona("Juan", saldoPersona, edad); // inclui la edad
} catch (error: any) {
...
const tragamonedasMaquinaDelTiempo= new Tragamonedas1 (false,false,false,false,false,["ho11la"],["h1111111la"],["ho22la"],"La Maquina Del Tiempo",1,[["string"]],"ho4545la","ho999la","ho888la",1,1,false);
//---------------------------------------------------------------------------------------------------------------
...
let juego: string; //se Crea String que luego se lee
...
//----------------------------------------------------------------------------------
        const respuesta:number = readlineSync.questionInt("\x1b[96m¿Desea seguir jugando? (1 para continuar, 2 para elegir otro juego o 0 para salir): \x1b[0m");
