...
//---------------------------------------------------------------------------------------------------------------
//Creamos objetos
let jugador1 = new Persona_1.Persona("Juan", saldoPersona); //inicio Clase Persona con nombre y Saldo Inicial
...
function elegirJuego(casino) {
    let juego; //se Crea String que luego se le 
...
function iniciarJuego(casino, juegoIndex, jugador1) {
    ...
    while (seguirJugando) {
        ...
        while (seguirJugandoEste) { //inicia un while con true
            ...
            //----------------------------------------------------------------------------------
            const respuesta = readlineSync.questionInt("¿Desea seguir jugando? (1 para continuar, 2 para elegir otro juego o 0 para salir): ");
